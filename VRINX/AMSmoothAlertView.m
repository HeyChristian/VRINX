...
{
    UIView * alertSquare = [[UIView alloc]initWithFrame:CGRectMake(0, 0, 280, 160)]; //200,150
...
- (void) circleSetupForAlertType:(AlertType) type andColor:(UIColor*) color
{
    ...
    switch (type) {
        ...
        case AlertInfo:
            ...
            break;
        case AlertSelection:
            [_logoView setImage:[UIImage imageNamed:@"one_finger.png"]];
            break;
        default:
            break;
    }
...
{
    _titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, 250, 30)];//180
    _titleLabel.center = CGPointMake(alertView.frame.size.width/2, 45);
    _titleLabel.text = title;
    _titleLabel.font = [UIFont fontWithName:@"HelveticaNeue-LightItalic" size:18.0f];
    _titleLabel.textAlignment = NSTextAlignmentCenter;
    
    [alertView addSubview:_titleLabel];
    
    
    _textLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, 250, 50)];
...
- (void) buttonSetupForType:(AlertType)type withCancelButton:(BOOL) hasCancelButton andColor:(UIColor*) color
{
    ...
    if (hasCancelButton) {
        //default button
        _defaultButton = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, 120, 30)]; //84
    ...
    else
    {
        switch (type) {
            ...
            case AlertInfo:
                ...
                break;
            case AlertSelection:
                 btn.backgroundColor = [Tools colorWithHexString:@"2293f5"];
                break;
            default:
                break;
        }
