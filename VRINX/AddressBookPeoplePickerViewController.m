...
// ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//
@interface AddressBookPeoplePickerViewController () <ABPeoplePickerNavigationControllerDelegate, ABPersonViewControllerDelegate, ABNewPersonViewControllerDelegate, UINavigationControllerDelegate,AMSmoothAlertViewDelegate>
...
- (void) loadContacts {
    ...
    if(!self.addressBook_cf){
        self.addressBook_cf = ABAddressBookCreateWithOptions(nil,error);//ABAddressBookCreate();
    }
...
- (void)navigationController:(UINavigationController *)navigationController didShowViewController:(UIViewController *)viewController animated:(BOOL)animated
{
    ...
    // ABPeoplePickerNavigationController
        ...
        if(self.addressBookCallbackFired){
            ...
            CFErrorRef *error = nil;
            ABAddressBookRef addressBook_cf = ABAddressBookCreateWithOptions(nil,error);//ABAddressBookCreate();
...
- (void)peoplePickerNavigationCancel:(id)sender{
    ...
    //Perform back when press cancel button
